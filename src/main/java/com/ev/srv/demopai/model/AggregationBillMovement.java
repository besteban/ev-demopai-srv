...
/**
 * AggregationBillMovement
 */

@Data
@Builder
public class AggregationBillMovement  implements Serializable {
  ...
  private List<BillMovement> items = null;
  
  @JsonProperty("pending")

  @ApiModelProperty(value = "List of pending movements for a model object")
  private List<BillMovement> pending = null;
