...
/**
 * AggregationEvoMovement
 */

@Data
@Builder
public class AggregationEvoMovement  implements Serializable {
  ...
  private List<EvoMovement> items = null;
  
  @JsonProperty("pending")

  @ApiModelProperty(value = "List of pending movements for a model object")
  private List<EvoMovement> pending = null;
