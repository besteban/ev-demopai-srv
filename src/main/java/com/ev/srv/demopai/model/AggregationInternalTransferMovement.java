...
import com.ev.srv.demopai.model.InternalTransferMovement;
...
/**
 * AggregationInternalTransferMovement
 */

@Data
@Builder
public class AggregationInternalTransferMovement  implements Serializable {
  ...
  private List<InternalTransferMovement> items = null;
  
  @JsonProperty("pending")

  @ApiModelProperty(value = "List of pending movements for a model object")
  private List<InternalTransferMovement> pending = null;
